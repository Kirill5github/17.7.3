...
# Решил максимальное значение вывести в отдельную переменную, хотя возможны и вывести в print: print ('Максимальная сумма, которую вы можете заработать:', max(deposit)) 
